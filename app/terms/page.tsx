...
export const metadata: Metadata = {
  title: "Terms of Service | Tour Sydney Shopping Assistant",
  description:
    "The terms governing use of the Tour Sydney Shopping Assistant and its product catalogue and agentic commerce API.",
}
      ...
      <div className="flex flex-col gap-8 leading-relaxed text-foreground">
        <section className="flex flex-col gap-3">
          ...
          <p className="text-pretty text-muted-foreground">
            By accessing or using the Tour Sydney Shopping Assistant, its product catalogue API, or any agentic commerce
        ...
        <section className="flex flex-col gap-3">
          ...
          <p className="text-pretty text-muted-foreground">
            The Service lets shoppers discover Tour Sydney homewares and furniture, build styled room looks, and initiate
