...
export const metadata: Metadata = {
  title: "Terms of Service | Sydney Tour 2026 Shopping Assistant",
  description:
    "The terms governing use of the Sydney Tour 2026 Shopping Assistant and its product catalogue and agentic commerce API.",
}
      ...
      <div className="flex flex-col gap-8 leading-relaxed text-foreground">
        <section className="flex flex-col gap-3">
          ...
          <p className="text-pretty text-muted-foreground">
            By accessing or using the Sydney Tour 2026 Shopping Assistant, its product catalogue API, or any agentic commerce
        ...
        <section className="flex flex-col gap-3">
          ...
          <p className="text-pretty text-muted-foreground">
            The Service lets shoppers discover Sydney Tour 2026 homewares and furniture, build styled room looks, and initiate
