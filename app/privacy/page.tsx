...
export const metadata: Metadata = {
  title: "Privacy Policy | Sydney Tour 2026 Shopping Assistant",
  description:
    "How the Sydney Tour 2026 Shopping Assistant handles data when used with ChatGPT and the Sydney Tour 2026 product catalogue API.",
}
      ...
      <div className="flex flex-col gap-8 leading-relaxed text-foreground">
        <section className="flex flex-col gap-3">
          ...
          <p className="text-pretty text-muted-foreground">
            This service exposes a read-only product catalogue API used by the Sydney Tour 2026 Shopping Assistant, a custom GPT
            available in ChatGPT. It helps shoppers discover Sydney Tour 2026 homewares and furniture and build styled room looks.
        ...
        <section className="flex flex-col gap-3">
          ...
          <ul className="flex list-disc flex-col gap-2 pl-5 text-muted-foreground">
            <li>To search the Sydney Tour 2026 product catalogue and return matching products, prices, and images.</li>
        ...
        <section className="flex flex-col gap-3">
          ...
          <p className="text-pretty text-muted-foreground">
            For questions about this policy or the Sydney Tour 2026 Shopping Assistant, please contact the team that operates this
            deployment.
          </p>
        </section>
      </div>
