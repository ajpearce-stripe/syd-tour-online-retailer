...
export const metadata: Metadata = {
  title: "Privacy Policy | Tour Sydney Shopping Assistant",
  description:
    "How the Tour Sydney Shopping Assistant handles data when used with ChatGPT and the Tour Sydney product catalogue API.",
}
      ...
      <div className="flex flex-col gap-8 leading-relaxed text-foreground">
        <section className="flex flex-col gap-3">
          ...
          <p className="text-pretty text-muted-foreground">
            This service exposes a read-only product catalogue API used by the Tour Sydney Shopping Assistant, a custom GPT
            available in ChatGPT. It helps shoppers discover Tour Sydney homewares and furniture and build styled room looks.
        ...
        <section className="flex flex-col gap-3">
          ...
          <ul className="flex list-disc flex-col gap-2 pl-5 text-muted-foreground">
            <li>To search the Tour Sydney product catalogue and return matching products, prices, and images.</li>
        ...
        <section className="flex flex-col gap-3">
          ...
          <p className="text-pretty text-muted-foreground">
            For questions about this policy or the Tour Sydney Shopping Assistant, please contact the team that operates this
            deployment.
          </p>
        </section>
      </div>
