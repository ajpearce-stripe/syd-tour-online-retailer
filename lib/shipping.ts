// Sydney Tour 2026 delivery & loyalty pricing rules.
//
...
// Standard delivery is a flat fee (Sydney Tour 2026 increased this from $14.95 to $19.95).
...
export function computeAgentPrice({ items, fulfillment, isMember }: AgentPriceInput): AgentPriceResult {
  ...
  if (fulfillment === "delivery") {
    // Qualification is on the order value (subtotal), matching Sydney Tour 2026's wording
